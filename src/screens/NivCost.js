...
import { niveau_fixe_v } from "../api/api";
import { niveau_fixe_b } from "../api/api";
...
export default function NivCost() {
  ...
  return (
    <div className="info">
      ...
      <Button
        onClick={() => {
          niveau_fixe_v(dateDebut,periode,nominal,niveau,taux).then((res) => {
            setdata(res);
          });
        }}
        name="importer"
        ...
        <Button
        onClick={() => {
          niveau_fixe_b(dateFin,dateDebut,periode,nominal,niveau,taux).then((res) => {
            setdata(res);
          });
        }}
        name="Backtest"
